...
- Target: `pi-rail@pi-rail.local`, fallback `pi-rail@192.168.31.242`
- Hostname: `pi-rail`
- Deployment path: `/home/pi-rail/CC-UK-TR`
- App path: `/home/pi-rail/CC-UK-TR/piboard`

## Pi Self Check

- OS: Raspbian GNU/Linux 13 (trixie)
- Kernel: `Linux pi-rail 6.12.47+rpt-rpi-v7 #1 SMP Raspbian 1:6.12.47-1+rpt1 (2025-09-16) armv7l GNU/Linux`
...
- Existing demo directory: `/home/pi-rail/UK-transport-LED`
...
- Active old demo processes found:
  ...
  - `python3 -m http.server 8080` with cwd `/home/pi-rail/UK-transport-LED`
...
- Requirements file confirmed: `/home/pi-rail/CC-UK-TR/piboard/requirements.txt`
- Core files confirmed:
  - `/home/pi-rail/CC-UK-TR/piboard/main.py`
  - `/home/pi-rail/CC-UK-TR/piboard/config.py`
  - `/home/pi-rail/CC-UK-TR/piboard/piboard.service`
- Python validation:
...
env XDG_RUNTIME_DIR=/run/user/1000 \
    ...
    PYTHONUNBUFFERED=1 \
    setsid -f python3 /home/pi-rail/CC-UK-TR/piboard/main.py --portrait \
...
- Web server on `http://192.168.31.242:8080`
...
- Overview: `/Users/xde/Desktop/project/CC-UK-TR/piboard-deploy-overview.png`
- Final Overview after detached restart: `/Users/xde/Desktop/project/CC-UK-TR/piboard-deploy-final-overview.png`
- Rail: `/Users/xde/Desktop/project/CC-UK-TR/piboard-deploy-rail.png`
- Weather: `/Users/xde/Desktop/project/CC-UK-TR/piboard-deploy-weather.png`
- Schedule: `/Users/xde/Desktop/project/CC-UK-TR/piboard-deploy-schedule.png`
...
- `/home/pi-rail/piboard-deploy-backups/20260429-0232-kmsdrm-test/labwc-autostart`
- `/home/pi-rail/piboard-deploy-backups/20260429-0232-kmsdrm-test/labwc-environment`
- `/home/pi-rail/piboard-deploy-backups/20260429-0232-kmsdrm-test/labwc-rc.xml`
- `/home/pi-rail/piboard-deploy-backups/20260429-0232-kmsdrm-test/uk-transport-led.service`
- `/home/pi-rail/piboard-deploy-backups/20260429-0232-kmsdrm-test/display-manager.status`
- `/home/pi-rail/piboard-deploy-backups/20260429-0232-kmsdrm-test/uk-transport-led.status`
...
- Web API worked at `http://192.168.31.242:8080`.
...
- `/home/pi-rail/CC-UK-TR/piboard/apps/uk_station/app.py`
- local source: `/Users/xde/Desktop/project/CC-UK-TR/piboard/apps/uk_station/app.py`
...
- `/Users/xde/Desktop/project/CC-UK-TR/piboard/deployment/piboard-kmsdrm.service`
...
```ini
User=pi-rail
WorkingDirectory=/home/pi-rail/CC-UK-TR/piboard
ExecStart=/usr/bin/python3 /home/pi-rail/CC-UK-TR/piboard/main.py --portrait
...
- Active display process: `/usr/bin/python3 /home/pi-rail/CC-UK-TR/piboard/main.py --portrait`
...
- `/Users/xde/Desktop/project/CC-UK-TR/piboard/main.py`
- `/Users/xde/Desktop/project/CC-UK-TR/piboard/host/host.py`
- `/Users/xde/Desktop/project/CC-UK-TR/piboard/deployment/piboard-kmsdrm.service`
...
- `/Users/xde/Desktop/project/CC-UK-TR/piboard/sources/weather.py`
- `/Users/xde/Desktop/project/CC-UK-TR/piboard/providers/weather.py`
- `/Users/xde/Desktop/project/CC-UK-TR/piboard/providers/weather_bridge.py`
- `/Users/xde/Desktop/project/CC-UK-TR/piboard/bindings/weather_to_uk.py`
- `/Users/xde/Desktop/project/CC-UK-TR/piboard/state.py`
- `/Users/xde/Desktop/project/CC-UK-TR/piboard/web/static/app.js`
- `/Users/xde/Desktop/project/CC-UK-TR/piboard/web/server.py`
- `/Users/xde/Desktop/project/CC-UK-TR/piboard/data/fetcher.py`
...
- `/Users/xde/Desktop/project/CC-UK-TR/piboard/weather-beijing-live-check.json`
- `/Users/xde/Desktop/project/CC-UK-TR/piboard/weather-beijing-live-check.png`
...
```bash
/home/pi-rail/piboard-deploy-backups/20260429-0232-kmsdrm-test/
```

### Local Low-Power Dynamic Prep - 2026-04-29

Local-only changes prepared while the Pi hardware is unavailable. These changes
have not yet been synced to `/home/pi-rail/CC-UK-TR/piboard`.
